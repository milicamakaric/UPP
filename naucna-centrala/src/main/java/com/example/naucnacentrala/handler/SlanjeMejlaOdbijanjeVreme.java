...
@Service
public class SlanjeMejlaOdbijanjeVreme implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        System.out.println("usao u SlanjeMejlaOdbijanjeVreme");
        ...
        try {
            ...
            message.setSubject("Odbijanje rada (tehnicki razlozi)");

            message.setText("Postovani/a, " + autor.getIme() + " " + autor.getPrezime() + "\n\n" +
                    "Vas rad pod nazivom " + rad.getNaslov() + " je odbijen zbog tehnickih razloga.\n\n Srdacno,\n Naucna centrala");
        ...
        System.out.println("izasao iz SlanjeMejlaOdbijanjeVreme");
