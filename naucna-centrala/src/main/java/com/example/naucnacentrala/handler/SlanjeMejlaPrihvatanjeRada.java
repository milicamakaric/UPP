...
@Service
public class SlanjeMejlaPrihvatanjeRada implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        System.out.println("usao u SlanjeMejlaPrihvatanjeRada");
        ...
        try {
            ...
            message.setSubject("Prihvatanje rada");

            message.setText("Postovani/a, " + autor.getIme() + " " + autor.getPrezime() + "\n\n" +
                    "Vas rad pod nazivom " + rad.getNaslov() + " je prihvacen za objavljivanje u casopisu " + rad.getCasopis().getNaziv() +".\n\n Srdacno,\n Naucna centrala");
        ...
        System.out.println("izasao iz SlanjeMejlaPrihvatanjeRada");
