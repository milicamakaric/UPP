...
@Service
public class SlanjeMejlaTematskiNeprihvatljiv implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        System.out.println("usao u SlanjeMejlaTematskiNeprihvatljiv");
        ...
        try {
            ...
            message.setSubject("Odbijanje rada (tematski neprihvatljiv)");

            message.setText("Postovani/a, " + autor.getIme() + " " + autor.getPrezime() + "\n\n" +
                    "Vas rad pod nazivom " + rad.getNaslov() + " je odbijen jer nije tematski prihvatljiv za casopis " + rad.getCasopis().getNaziv() + ".\n\n Srdacno,\n Naucna centrala");
        ...
        System.out.println("izasao iz SlanjeMejlaTematskiNeprihvatljiv");
