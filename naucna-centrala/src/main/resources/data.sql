...
insert into korisnik (id, ime, prezime, grad, drzava, email, username, password, aktiviran, recenzent)
values (2, "Tamara", "Makaric", "Stepanovicevo", "Srbija", "makaric.milica@gmail.com", "taca", "$2a$10$ifANXgSrjBgprG81FsGmLu5xuE4CkcmLXCi335AM5fDI2faPRz1dO", true, 3);
insert into korisnik (id, ime, prezime, grad, drzava, email, username, password, aktiviran, recenzent)
values (7, "Nikola", "Malencic", "Novi Sad", "Srbija", "makaric.milica@gmail.com", "mace", "$2a$10$ifANXgSrjBgprG81FsGmLu5xuE4CkcmLXCi335AM5fDI2faPRz1dO", true, 3);
insert into korisnik (id, ime, prezime, grad, drzava, email, username, password, aktiviran, recenzent)
values (8, "Nikola", "Djordjevic", "Novi Sad", "Srbija", "makaric.milica@gmail.com", "djo", "$2a$10$ifANXgSrjBgprG81FsGmLu5xuE4CkcmLXCi335AM5fDI2faPRz1dO", true, 3);
insert into korisnik (id, ime, prezime, grad, drzava, email, username, password, aktiviran, recenzent)
values (11, "Tomo", "Kolak", "Novi Sad", "Srbija", "makaric.milica@gmail.com", "tomo", "$2a$10$ifANXgSrjBgprG81FsGmLu5xuE4CkcmLXCi335AM5fDI2faPRz1dO", true, 3);
